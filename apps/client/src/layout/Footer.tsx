      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-4 w-full px-4 md:px-6 py-16 md:py-20 max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex gap-4 mt-2">
            <a
              ...
              className="w-10 h-10 rounded-full bg-surface-container flex items-center justify-center text-on-surface-variant hover:text-primary-fixed hover:bg-primary-fixed/10 transition-all duration-200"
        ...
        <div className="grid grid-cols-2 gap-8">
          <div className="flex flex-col gap-4">
            ...
            <nav className="flex flex-col gap-3" aria-label="Enlaces de producto">
              {productLinks.map((link) => (
                <a
                  key={link.label}
                  href={link.href}
                  className="font-label text-sm text-on-surface-variant hover:text-primary-fixed transition-colors duration-200"
                >
                  {link.label}
                </a>
              ))}
          ...
          <div className="flex flex-col gap-4">
            ...
            <nav className="flex flex-col gap-3" aria-label="Enlaces de contacto">
